...
class RepeaterWizard extends Field
{
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(static function (RepeaterWizard $component, ?array $state): void {
        ...
        $this->registerActions([
            fn (RepeaterWizard $component): Action => $component->getAddAction(),
            fn (RepeaterWizard $component): Action => $component->getCloneAction(),
            fn (RepeaterWizard $component): Action => $component->getCollapseAction(),
            fn (RepeaterWizard $component): Action => $component->getCollapseAllAction(),
            fn (RepeaterWizard $component): Action => $component->getDeleteAction(),
            fn (RepeaterWizard $component): Action => $component->getExpandAction(),
            fn (RepeaterWizard $component): Action => $component->getExpandAllAction(),
            fn (RepeaterWizard $component): Action => $component->getMoveDownAction(),
            fn (RepeaterWizard $component): Action => $component->getMoveUpAction(),
            fn (RepeaterWizard $component): Action => $component->getReorderAction(),
        ]);

        $this->mutateDehydratedStateUsing(static function (RepeaterWizard $component, ?array $state): array {
    ...
    public function getAddAction(): Action
    {
        $action = Action::make($this->getAddActionName())
            ->label(fn (RepeaterWizard $component) => $component->getAddActionLabel())
            ->color('gray')
            ->action(function (RepeaterWizard $component): void {
    ...
    public function getCloneAction(): Action
    {
        $action = Action::make($this->getCloneActionName())
            ...
            ->color('gray')
            ->action(function (array $arguments, RepeaterWizard $component): void {
                $newUuid = (string) Str::uuid();
    ...
    {
        $this->default(static function (RepeaterWizard $component) use ($count): array {
    ...
    {
        parent::default(function (RepeaterWizard $component) use ($shouldPreserveChildState, $state) {
    ...
    {
        $this->addable(fn (RepeaterWizard $component): bool => ! $this->evaluate($condition));
    ...
    {
        $this->deletable(fn (RepeaterWizard $component): bool => ! $this->evaluate($condition));
    ...
    {
        $this->reorderable(fn (RepeaterWizard $component): bool => ! $this->evaluate($condition));
    ...
    public function relationship(string | Closure | null $name = null, ?Closure $modifyQueryUsing = null): static
    {
        ...
        $this->afterStateHydrated(function (RepeaterWizard $component) {
            if (! is_array($component->hydratedDefaultState)) {
                return;
            }
        ...
        $this->loadStateFromRelationshipsUsing(static function (RepeaterWizard $component) {
            $component->clearCachedExistingRecords();

            $component->fillFromRelationship();
        });

        $this->saveRelationshipsUsing(static function (RepeaterWizard $component, HasForms $livewire, ?array $state) {
            if (! is_array($state)) {
                $state = [];
            }
